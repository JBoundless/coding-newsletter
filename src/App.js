  ...
  return (
    <div className="min-h-screen flex flex-col text-white">
      <main className="container mx-auto px-6 pt-16 flex-1 text-center">
        ...
        <form
          action="https://www.getrevue.co/profile/jordanboundless/add_subscriber"
          method="post"
          id="revue-form"
          name="revue-form"
          target="_blank"
        >
          ...
          <div class="revue-form-actions">
            <input
              ...
              className="bg-orange-400 md:rounded-tl-none md:rounded-bl-none rounded-full text-2xl py-4 px-6 md:px-10 lg:py-6 lg:px-12 font-bold uppercase cursor-pointer hover:opacity-75 duration-150"
            />
          </div>
      ...
      <footer className="container mx-auto p-6">
        <p>Built by Jordan Pagkalinawan</p>
        <div className="fkex -mx-6">
